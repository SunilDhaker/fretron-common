...
public class Constants {
    ...
    public static final String HUBS_MANAGER_COLLECTION_NAME = "hubs.collection.name";
    ...
    public static final String SHIPMENT_UPDATESCREEN_COLLECTION_NAME = "shipment.updatescreen.collection.name";
    public static final String SHIPMENT_REMINDER_COLLECTION_NAME = "shipment.reminder.collection.name";
    ...
    */
    ...
    public static final String WFMS_TASK_COLLECTION_NAME = "wfms.task.collection.name";
    public static final String KEY_WFMS_TASK_TOPIC = "wfms.task.topic";
