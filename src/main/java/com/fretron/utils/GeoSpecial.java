...
public class GeoSpecial {
	...
	public static boolean coordinateInRegion(ArrayList<Location> regionIn, Location coord) {
		...
		if(region.get(region.size()-1).longitude == region.get(0).longitude && region.get(region.size()-1).latitude == region.get(0).latitude){
	...
	public static ArrayList<Location> getNPointsOnPerimeter(Location center , double radius , int number){
