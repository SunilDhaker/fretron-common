    ...
    public TimeAwarePolyline compress(TimeAwarePolyline polylineObj){
        ...
        try {
            ...
            if (polyline != null) {
                ...
                TimeAwarePolyline compressedPolylineObj = extendTimeAwarePolyline(new TimeAwarePolyline("", "", new PointAtTime(0l, 0d, 0d) ,false), compressedPointList.get(0).getX(), compressedPointList.get(0).getY(), compressedPointList.get(0).getT());
