...
public class Terminal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.lang.String controllingBranchId;
  @Deprecated public java.lang.String terminalType;
  @Deprecated public com.fretron.Model.Employee terminalIncharge;
   ...
   * @param controllingBranchId The new value for controllingBranchId
   * @param terminalType The new value for terminalType
   * @param terminalIncharge The new value for terminalIncharge
   * @param status The new value for status
   */
  public Terminal(java.lang.String name, java.lang.String address, java.lang.String category, com.fretron.Model.Location center, java.util.List<java.lang.Double> centerCoordinates, java.lang.Double suggestedRadius, com.fretron.Model.ViewPort viewport, java.lang.String source, java.lang.String addedBy, java.lang.String placeId, java.lang.String externalId, java.lang.String hubId, java.lang.String state, java.lang.String district, java.lang.String subDistrict, java.util.List<java.util.List<java.util.List<java.lang.Double>>> boundary, java.util.List<com.fretron.Model.Place> places, java.lang.String accessibility, java.lang.Boolean isOwned, com.fretron.Model.Geometry geoJsonBoundry, java.lang.String controllingBranchId, java.lang.String terminalType, com.fretron.Model.Employee terminalIncharge, java.lang.String status) {
    this.name = name;
    ...
    this.controllingBranchId = controllingBranchId;
    this.terminalType = terminalType;
    this.terminalIncharge = terminalIncharge;
    this.status = status;
  }
  ...
  public java.lang.Object get(int field$) {
    ...
    case 20: return controllingBranchId;
    case 21: return terminalType;
    case 22: return terminalIncharge;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 20: controllingBranchId = (java.lang.String)value$; break;
    case 21: terminalType = (java.lang.String)value$; break;
    case 22: terminalIncharge = (com.fretron.Model.Employee)value$; break;
  ...
  /**
   * Gets the value of the 'controllingBranchId' field.
   * @return The value of the 'controllingBranchId' field.
   */
  public java.lang.String getControllingBranchId() {
    return controllingBranchId;
  }

  /**
   * Sets the value of the 'controllingBranchId' field.
   * @param value the value to set.
   */
  public void setControllingBranchId(java.lang.String value) {
    this.controllingBranchId = value;
  }

  /**
   * Gets the value of the 'terminalType' field.
   * @return The value of the 'terminalType' field.
   */
  ...
  /**
   * Sets the value of the 'terminalType' field.
   * @param value the value to set.
   */
  ...
  /**
   * Gets the value of the 'terminalIncharge' field.
   * @return The value of the 'terminalIncharge' field.
   */
  public com.fretron.Model.Employee getTerminalIncharge() {
    return terminalIncharge;
  }

  /**
   * Sets the value of the 'terminalIncharge' field.
   * @param value the value to set.
   */
  public void setTerminalIncharge(com.fretron.Model.Employee value) {
    this.terminalIncharge = value;
  }
  ...
  /**
   * Creates a new Terminal RecordBuilder.
   * @return A new Terminal RecordBuilder
   */
  public static com.fretron.Model.Terminal.Builder newBuilder() {
    return new com.fretron.Model.Terminal.Builder();
  }

  /**
   * Creates a new Terminal RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new Terminal RecordBuilder
   */
  public static com.fretron.Model.Terminal.Builder newBuilder(com.fretron.Model.Terminal.Builder other) {
    return new com.fretron.Model.Terminal.Builder(other);
  }

  /**
   * Creates a new Terminal RecordBuilder by copying an existing Terminal instance.
   * @param other The existing instance to copy.
   * @return A new Terminal RecordBuilder
   */
  public static com.fretron.Model.Terminal.Builder newBuilder(com.fretron.Model.Terminal other) {
    return new com.fretron.Model.Terminal.Builder(other);
  }

  /**
   * RecordBuilder for Terminal instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Terminal>
    implements org.apache.avro.data.RecordBuilder<Terminal> {
    ...
    private java.lang.String controllingBranchId;
    private java.lang.String terminalType;
    private com.fretron.Model.Employee terminalIncharge;
    private com.fretron.Model.Employee.Builder terminalInchargeBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fretron.Model.Terminal.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[20], other.controllingBranchId)) {
        this.controllingBranchId = data().deepCopy(fields()[20].schema(), other.controllingBranchId);
        fieldSetFlags()[20] = true;
      }
      if (isValidValue(fields()[21], other.terminalType)) {
        this.terminalType = data().deepCopy(fields()[21].schema(), other.terminalType);
        fieldSetFlags()[21] = true;
      }
      if (isValidValue(fields()[22], other.terminalIncharge)) {
        this.terminalIncharge = data().deepCopy(fields()[22].schema(), other.terminalIncharge);
        fieldSetFlags()[22] = true;
      }
      if (other.hasTerminalInchargeBuilder()) {
        this.terminalInchargeBuilder = com.fretron.Model.Employee.newBuilder(other.getTerminalInchargeBuilder());
      }
    ...
    /**
     * Creates a Builder by copying an existing Terminal instance
     * @param other The existing instance to copy.
     */
    private Builder(com.fretron.Model.Terminal other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
      ...
      this.terminalInchargeBuilder = null;
      if (isValidValue(fields()[23], other.status)) {
        this.status = data().deepCopy(fields()[23].schema(), other.status);
        fieldSetFlags()[23] = true;
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setCategory(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearCategory() {
      category = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setCenter(com.fretron.Model.Location value) {
     ...
     * @return This builder.
     */
    public com.fretron.Model.Terminal.Builder setCenterBuilder(com.fretron.Model.Location.Builder value) {
      clearCenter();
      centerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearCenter() {
      center = null;
      centerBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setCenterCoordinates(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearCenterCoordinates() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setSuggestedRadius(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearSuggestedRadius() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setViewport(com.fretron.Model.ViewPort value) {
     ...
     * @return This builder.
     */
    public com.fretron.Model.Terminal.Builder setViewportBuilder(com.fretron.Model.ViewPort.Builder value) {
      clearViewport();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearViewport() {
      viewport = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setSource(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearSource() {
      source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setAddedBy(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearAddedBy() {
      addedBy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setPlaceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearPlaceId() {
      placeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setExternalId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearExternalId() {
      externalId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setHubId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearHubId() {
      hubId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setState(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setDistrict(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearDistrict() {
      district = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setSubDistrict(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearSubDistrict() {
      subDistrict = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setBoundary(java.util.List<java.util.List<java.util.List<java.lang.Double>>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearBoundary() {
      boundary = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setPlaces(java.util.List<com.fretron.Model.Place> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearPlaces() {
      places = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setAccessibility(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearAccessibility() {
      accessibility = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setIsOwned(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearIsOwned() {
      isOwned = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setGeoJsonBoundry(com.fretron.Model.Geometry value) {
     ...
     * @return This builder.
     */
    public com.fretron.Model.Terminal.Builder setGeoJsonBoundryBuilder(com.fretron.Model.Geometry.Builder value) {
      clearGeoJsonBoundry();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearGeoJsonBoundry() {
      geoJsonBoundry = null;
    ...
    /**
      * Sets the value of the 'controllingBranchId' field.
      * @param value The value of 'controllingBranchId'.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setControllingBranchId(java.lang.String value) {
    ...
    /**
      * Checks whether the 'controllingBranchId' field has been set.
      * @return True if the 'controllingBranchId' field has been set, false otherwise.
      */
    public boolean hasControllingBranchId() {
      return fieldSetFlags()[20];
    }


    /**
      * Clears the value of the 'controllingBranchId' field.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearControllingBranchId() {
    ...
    /**
      * Sets the value of the 'terminalType' field.
      * @param value The value of 'terminalType'.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setTerminalType(java.lang.String value) {
    ...
    /**
      * Checks whether the 'terminalType' field has been set.
      * @return True if the 'terminalType' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'terminalType' field.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearTerminalType() {
      terminalType = null;
    ...
    /**
      * Sets the value of the 'terminalIncharge' field.
      * @param value The value of 'terminalIncharge'.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setTerminalIncharge(com.fretron.Model.Employee value) {
    ...
    /**
      * Checks whether the 'terminalIncharge' field has been set.
      * @return True if the 'terminalIncharge' field has been set, false otherwise.
      */
    public boolean hasTerminalIncharge() {
      return fieldSetFlags()[22];
    }

    /**
     * Gets the Builder instance for the 'terminalIncharge' field and creates one if it doesn't exist yet.
     * @return This builder.
     */
    public com.fretron.Model.Employee.Builder getTerminalInchargeBuilder() {
      if (terminalInchargeBuilder == null) {
        if (hasTerminalIncharge()) {
          setTerminalInchargeBuilder(com.fretron.Model.Employee.newBuilder(terminalIncharge));
        } else {
          setTerminalInchargeBuilder(com.fretron.Model.Employee.newBuilder());
        }
      }
      return terminalInchargeBuilder;
    }

    /**
     * Sets the Builder instance for the 'terminalIncharge' field
     * @param value The builder instance that must be set.
     * @return This builder.
     */
    public com.fretron.Model.Terminal.Builder setTerminalInchargeBuilder(com.fretron.Model.Employee.Builder value) {
      clearTerminalIncharge();
      terminalInchargeBuilder = value;
      return this;
    }

    /**
     * Checks whether the 'terminalIncharge' field has an active Builder instance
     * @return True if the 'terminalIncharge' field has an active Builder instance
     */
    public boolean hasTerminalInchargeBuilder() {
      return terminalInchargeBuilder != null;
    }

    /**
      * Clears the value of the 'terminalIncharge' field.
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearTerminalIncharge() {
      terminalIncharge = null;
      terminalInchargeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Terminal.Builder clearStatus() {
      status = null;
    ...
    public Terminal build() {
      try {
        ...
        record.controllingBranchId = fieldSetFlags()[20] ? this.controllingBranchId : (java.lang.String) defaultValue(fields()[20]);
        record.terminalType = fieldSetFlags()[21] ? this.terminalType : (java.lang.String) defaultValue(fields()[21]);
        if (terminalInchargeBuilder != null) {
          record.terminalIncharge = this.terminalInchargeBuilder.build();
        } else {
          record.terminalIncharge = fieldSetFlags()[22] ? this.terminalIncharge : (com.fretron.Model.Employee) defaultValue(fields()[22]);
        }
