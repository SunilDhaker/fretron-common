...
public class Issue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.fretron.Model.OrgOffice orgId;
   ...
   */
  public Issue(java.lang.String uuid, java.lang.String resourceId, java.lang.String resourceType, java.lang.String issueSummery, java.lang.String issueType, java.lang.String issueDescription, com.fretron.Model.User reporter, com.fretron.Model.User assignee, com.fretron.Model.User creator, java.lang.String priority, java.lang.String status, java.lang.Long createdAt, java.lang.Long updatedAt, java.lang.String updatedBy, java.lang.Long resolutionDate, java.lang.Long resolutionDuration, java.lang.Long estimatedResolutionDate, java.util.List<com.fretron.Model.User> userWatchers, java.util.List<com.fretron.Model.User> userFollowers, java.util.List<com.fretron.Model.BuisnessPartner> bpartnerFollowers, java.util.List<com.fretron.Model.BuisnessPartner> bpartnerWatchers, java.util.List<java.lang.String> tags, java.util.List<com.fretron.Model.Comment> comments, java.util.List<com.fretron.Model.Document> attachments, java.util.List<com.fretron.Model.CustomeField> customeFields, com.fretron.Model.Updates updates, java.util.List<java.lang.String> filterTags, java.lang.String resourceIdentifier, com.fretron.Model.OrgOffice branch, com.fretron.Model.OrgOffice orgId) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 29: orgId = (com.fretron.Model.OrgOffice)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.fretron.Model.OrgOffice getOrgId() {
    return orgId;
  }
   ...
   * @param value the value to set.
   */
  public void setOrgId(com.fretron.Model.OrgOffice value) {
    this.orgId = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Issue>
    ...
    private com.fretron.Model.OrgOffice orgId;
    private com.fretron.Model.OrgOffice.Builder orgIdBuilder;
    ...
    private Builder(com.fretron.Model.Issue.Builder other) {
      ...
      if (other.hasOrgIdBuilder()) {
        this.orgIdBuilder = com.fretron.Model.OrgOffice.newBuilder(other.getOrgIdBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.Issue.Builder setOrgId(com.fretron.Model.OrgOffice value) {
    ...
    /**
     * Gets the Builder instance for the 'orgId' field and creates one if it doesn't exist yet.
     * @return This builder.
     */
    public com.fretron.Model.OrgOffice.Builder getOrgIdBuilder() {
      if (orgIdBuilder == null) {
        if (hasOrgId()) {
          setOrgIdBuilder(com.fretron.Model.OrgOffice.newBuilder(orgId));
        } else {
          setOrgIdBuilder(com.fretron.Model.OrgOffice.newBuilder());
        }
      }
      return orgIdBuilder;
    }
    ...
    /**
     * Sets the Builder instance for the 'orgId' field
     * @param value The builder instance that must be set.
     * @return This builder.
     */
    public com.fretron.Model.Issue.Builder setOrgIdBuilder(com.fretron.Model.OrgOffice.Builder value) {
      clearOrgId();
      orgIdBuilder = value;
      return this;
    }
    ...
    /**
     * Checks whether the 'orgId' field has an active Builder instance
     * @return True if the 'orgId' field has an active Builder instance
     */
    public boolean hasOrgIdBuilder() {
      return orgIdBuilder != null;
    }
    ...
    public Issue build() {
      try {
        ...
        if (orgIdBuilder != null) {
          record.orgId = this.orgIdBuilder.build();
        } else {
          record.orgId = fieldSetFlags()[29] ? this.orgId : (com.fretron.Model.OrgOffice) defaultValue(fields()[29]);
        }
        return record;
      } catch (Exception e) {
