...
public class NotificationCommand extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6265810338026086819L;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 24: scheduleTime = (java.lang.Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationCommand>
    ...
    private Builder(com.fretron.Model.NotificationCommand.Builder other) {
      ...
      if (isValidValue(fields()[24], other.scheduleTime)) {
        this.scheduleTime = data().deepCopy(fields()[24].schema(), other.scheduleTime);
    ...
    public NotificationCommand build() {
      try {
        ...
        record.scheduleTime = fieldSetFlags()[24] ? this.scheduleTime : (java.lang.Long) defaultValue(fields()[24]);
        return record;
      } catch (Exception e) {
