...
public class FleetRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.fretron.Model.UserOrgACL vehicleSupervisor;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 19: vehicleSupervisor = (com.fretron.Model.UserOrgACL)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.fretron.Model.UserOrgACL getVehicleSupervisor() {
   ...
   * @param value the value to set.
   */
  public void setVehicleSupervisor(com.fretron.Model.UserOrgACL value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FleetRecord>
    ...
    private com.fretron.Model.UserOrgACL vehicleSupervisor;
    private com.fretron.Model.UserOrgACL.Builder vehicleSupervisorBuilder;
    ...
    private Builder(com.fretron.Model.FleetRecord.Builder other) {
      ...
      if (other.hasVehicleSupervisorBuilder()) {
        this.vehicleSupervisorBuilder = com.fretron.Model.UserOrgACL.newBuilder(other.getVehicleSupervisorBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fretron.Model.FleetRecord.Builder setVehicleSupervisor(com.fretron.Model.UserOrgACL value) {
     ...
     * @return This builder.
     */
    public com.fretron.Model.UserOrgACL.Builder getVehicleSupervisorBuilder() {
      if (vehicleSupervisorBuilder == null) {
        if (hasVehicleSupervisor()) {
          setVehicleSupervisorBuilder(com.fretron.Model.UserOrgACL.newBuilder(vehicleSupervisor));
        } else {
          setVehicleSupervisorBuilder(com.fretron.Model.UserOrgACL.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.fretron.Model.FleetRecord.Builder setVehicleSupervisorBuilder(com.fretron.Model.UserOrgACL.Builder value) {
    ...
    public FleetRecord build() {
      try {
        ...
        if (vehicleSupervisorBuilder != null) {
          ...
          record.vehicleSupervisor = fieldSetFlags()[19] ? this.vehicleSupervisor : (com.fretron.Model.UserOrgACL) defaultValue(fields()[19]);
        }
        return record;
      } catch (Exception e) {
