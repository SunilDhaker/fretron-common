...
public class FreightPurchaseOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<java.lang.String> salesOrder;
   ...
   * @param salesOrder The new value for salesOrder
   * @param tnCs The new value for tnCs
   */
  public FreightPurchaseOrder(java.lang.String uuid, java.lang.String externalId, java.lang.String orgId, com.fretron.Model.BuisnessPartner vendor, java.lang.String orderType, java.lang.String status, java.lang.Long placementDate, com.fretron.Model.Place origin, com.fretron.Model.Place destination, java.lang.String material, java.lang.String vehicleType, java.util.List<java.lang.String> salesOrder, java.util.List<com.fretron.Model.ContractTerms> tnCs) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: vendor = (com.fretron.Model.BuisnessPartner)value$; break;
    case 4: orderType = (java.lang.String)value$; break;
    case 5: status = (java.lang.String)value$; break;
    case 6: placementDate = (java.lang.Long)value$; break;
    ...
    case 11: salesOrder = (java.util.List<java.lang.String>)value$; break;
    case 12: tnCs = (java.util.List<com.fretron.Model.ContractTerms>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'salesOrder' field.
   * @return The value of the 'salesOrder' field.
   */
  public java.util.List<java.lang.String> getSalesOrder() {
    return salesOrder;
  }

  /**
   * Sets the value of the 'salesOrder' field.
   * @param value the value to set.
   */
  public void setSalesOrder(java.util.List<java.lang.String> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FreightPurchaseOrder>
    ...
    private java.util.List<java.lang.String> salesOrder;
    ...
    private Builder(com.fretron.Model.FreightPurchaseOrder.Builder other) {
      ...
      if (isValidValue(fields()[3], other.vendor)) {
        this.vendor = data().deepCopy(fields()[3].schema(), other.vendor);
      ...
      if (isValidValue(fields()[6], other.placementDate)) {
        this.placementDate = data().deepCopy(fields()[6].schema(), other.placementDate);
      ...
      if (isValidValue(fields()[11], other.salesOrder)) {
        this.salesOrder = data().deepCopy(fields()[11].schema(), other.salesOrder);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.tnCs)) {
        this.tnCs = data().deepCopy(fields()[12].schema(), other.tnCs);
    ...
    /**
      * Sets the value of the 'salesOrder' field.
      * @param value The value of 'salesOrder'.
      * @return This builder.
      */
    public com.fretron.Model.FreightPurchaseOrder.Builder setSalesOrder(java.util.List<java.lang.String> value) {
    ...
    /**
      * Checks whether the 'salesOrder' field has been set.
      * @return True if the 'salesOrder' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'salesOrder' field.
      * @return This builder.
      */
    public com.fretron.Model.FreightPurchaseOrder.Builder clearSalesOrder() {
      salesOrder = null;
    ...
    public FreightPurchaseOrder build() {
      try {
        ...
        if (vendorBuilder != null) {
          ...
          record.vendor = fieldSetFlags()[3] ? this.vendor : (com.fretron.Model.BuisnessPartner) defaultValue(fields()[3]);
        }
        record.orderType = fieldSetFlags()[4] ? this.orderType : (java.lang.String) defaultValue(fields()[4]);
        record.status = fieldSetFlags()[5] ? this.status : (java.lang.String) defaultValue(fields()[5]);
        record.placementDate = fieldSetFlags()[6] ? this.placementDate : (java.lang.Long) defaultValue(fields()[6]);
        if (originBuilder != null) {
        ...
        record.salesOrder = fieldSetFlags()[11] ? this.salesOrder : (java.util.List<java.lang.String>) defaultValue(fields()[11]);
        record.tnCs = fieldSetFlags()[12] ? this.tnCs : (java.util.List<com.fretron.Model.ContractTerms>) defaultValue(fields()[12]);
        return record;
      } catch (Exception e) {
